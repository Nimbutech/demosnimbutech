...
class SaleSubscription(models.Model):
    ...
    def _prepare_invoice_line(self, line, fiscal_position, date_start=False, date_stop=False):
        ...
        if self.invoice_currency and partner.partner_currency_id == currency and partner.tasa_fija and self.currency_id and self.company_id and currency != self.company_id.currency_id:
